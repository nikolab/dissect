	...
	<div class="wrapper-full">
		<div class="holder">
			...
			<div class="tb-8">
				<ul class="questions">
					<li>
						<h1>How do I better understand how digital will disrupt my industry?</h1>
						<a href="">Read More</a>
					</li>
					<li>
						<h1>Where do I start my digital transformation journey?</h1>
						<a href="">Read More</a>
					</li>
					<li>
						<h1>How do I create a modern, cohesive brand that engages customers across the digital ecosystem?</h1>
...
<section class="problem-solving-img">
    <div class="wrapper-full">
        <img src="./assets/images/video-reel-placeholder.jpg" alt="problem solving">
    </div>
</section>
